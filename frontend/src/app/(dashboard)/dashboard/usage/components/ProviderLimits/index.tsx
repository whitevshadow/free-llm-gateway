            ...
            {PURCHASE_TYPES.map((type) => {
              ...
              return (
                <button
                  ...
                  style={{
                    border: active
                      ? "1px solid var(--color-primary, #6d4dfb)"
                      : "1px solid var(--color-border)",
                    background: active ? "rgba(var(--color-primary-rgb, 109, 77, 251), 0.1)" : "transparent",
                    color: active ? "var(--color-primary, #6d4dfb)" : "var(--color-text-muted)",
                  }}
                >
