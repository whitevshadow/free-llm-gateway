      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-16 items-start">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex gap-4 min-w-0">
                <div className="flex-none w-8 h-8 rounded-full bg-[#6D4DFB]/20 text-[#8B6BFF] flex items-center justify-center font-bold">
                  1
                </div>
                <div>
          ...
          <div className="flex-1 w-full">
            <div className="rounded-xl overflow-hidden bg-[#161A2B] border border-[#272C40] shadow-2xl">
              {/* Terminal header */}
              <div className="flex items-center gap-2 px-4 py-3 bg-[#111425] border-b border-gray-700">
              ...
              <div className="p-6 font-mono text-sm leading-relaxed overflow-x-hidden">
                ...
                <div className="text-gray-400 mb-6">
                  <span className="text-[#8B6BFF]">&gt;</span> {t("startingOmniRoute")}
                  <br />
                  <span className="text-[#8B6BFF]">&gt;</span> {t("serverRunningOnLabel")}{" "}
                  <span className="text-blue-400 break-all">{endpoint}</span>
                  <br />
                  <span className="text-[#8B6BFF]">&gt;</span> {t("dashboardLabel")}:{" "}
