...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[#272C40] bg-[#080A0F] pt-16 pb-8 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
          {/* Brand */}
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="size-6 rounded bg-[#6D4DFB] flex items-center justify-center text-white">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="text-gray-400 hover:text-[#8B6BFF] text-sm transition-colors"
              href="#features"
            >
              {t("featuresLink")}
            </a>
        ...
        {/* Bottom */}
        <div className="border-t border-[#272C40] pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
