export const HIDEABLE_SIDEBAR_ITEM_IDS = [
  ...
  "endpoints",
  "providers",
  // Screens written for this gateway (SRS §6.1, §12, §20) — not OmniRoute's.
  // Provider keys are covered by OmniRoute's own "API Keys" entry (api-manager),
  // so this gateway adds no second keys screen.
  "deployments",
  "gateway-models",
  "health-timeline",
  "errors",
